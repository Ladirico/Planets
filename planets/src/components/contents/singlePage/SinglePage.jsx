import { container, secondContainer, TitleContainer, underWrapper, left, right, underTitleCss1, underTitleCss } from "./SinglePage.module.css"
            ...
            <div className={secondContainer}>
                ...
                <div className={TitleContainer}>
                    {underTitle !== undefined ?
                        <span><h4 className={underTitleCss1}>{underTitle[0]}</h4> <h4 className={underTitleCss}>{underTitle[1]}</h4></span> :
